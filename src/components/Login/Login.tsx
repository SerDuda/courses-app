...
export const Login: React.FC = () => {
    ...
    const loginUser = (e: { target: { name: string, value: string } }) => {
    ...
    return (
        <div className="main-log">
            <form className="container-log" onSubmit={sendLoginInfo}>
                <h2>Login</h2>
                <Input labelText="Email" placeholdetText="Enter email" nameInput="email" valueText={userLogin.email} onChange={loginUser}/>
                <Input labelText="Password" placeholdetText="Enter password" nameInput="password" valueText={userLogin.password} onChange={loginUser}/>
