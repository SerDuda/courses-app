    ...
    return (
        <div className="main-regist">
            <form className="container-regist" onSubmit={sendNewUser}>
                <h2>Registration</h2>
                <Input labelText="Name" placeholdetText="Enter name" nameInput="name" valueText={formValue.name} onChange={createNewUser} />
                <Input labelText="Email" placeholdetText="Enter email" nameInput="email" valueText={formValue.email} onChange={createNewUser} />
                <Input labelText="Password" placeholdetText="Enter password" nameInput="password" valueText={formValue.password} onChange={createNewUser} />
